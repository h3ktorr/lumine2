   ...
   <div className="mt-14 w-full max-h-[100vh]">
    <div className="flex relative w-full h-full mens_footwear_gradient">
     ...
     <div className="absolute top-[75%] sm:top-[65%] lg:top-[50%] left-[30%] sm:left-[50%] lg:left-[45%] w-[50%] h-[30%]">
      ...
      <button className="absolute flex items-center justify-center bg-black text-white rounded-xl text-base lg:text-2xl p-2 font-Itim w-[30%] h-[20%] lg:h-[30%] cursor-pointer left-[35%] sm:left-[20%] lg:left-[25%] top-[30%] max-xs:text-[.9rem]">Shop</button>
     </div>
    </div>
   </div>
 )
