...
const page = async() => {
  const categoryId = process.env.MENS_FOOTWEAR_CATEGORY_ID!
  ...
  return (
    <div className="mt-14 w-[90vw] m-auto flex flex-col items-center">
     <div className="w-full h-[calc(100vh-56px)] men_footwear_bg bg-no-repeat bg-cover bg-center flex justify-center relative">
      <h2 className="font-Jacques absolute text-[1.7rem] sm:text-4xl lg:text-5xl text-black top-[70%] left-[40%] sm:left-[50%]">Footwear for you</h2>
     </div>
