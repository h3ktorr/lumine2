...
const page = async() => {
  const categoryId = process.env.HOODIE_CATEGORY_ID!
  ...
  return (
    <div className="mt-14 w-[90vw] m-auto flex flex-col items-center">
     <div className="w-full h-[calc(100vh-56px)] hoodie_bg bg-no-repeat bg-cover bg-center flex justify-center relative">
      <h2 className="font-Jacques absolute text-[1.7rem] sm:text-4xl lg:text-5xl text-white top-[50%]">Hoodies for you</h2>
     </div>
     <div className="w-full overflow-hidden mt-14 flex flex-col">
      <h1 className="font-Irish text-xl md:text-2xl cursor-pointer">Hoodies</h1>
