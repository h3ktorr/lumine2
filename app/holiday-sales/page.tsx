...
const page = async() => {
  const categoryId = process.env.HOLIDAY_SALE_CATEGORY_ID!
  ...
  return (
    <div className="mt-14 w-[90vw] m-auto flex flex-col items-center">
     <div className="w-full h-[calc(100vh-56px)] holiday_sale_bg bg-no-repeat bg-cover bg-center flex justify-center relative">
      <h2 className="font-Jacques absolute text-[1.7rem] sm:text-4xl lg:text-5xl text-black top-[50%]">Holiday Sales</h2>
     </div>
     <div className="w-full overflow-hidden mt-14 flex flex-col">
      <h1 className="font-Irish text-xl md:text-2xl cursor-pointer">Holiday Sales</h1>
